...
class EmployeeProfileUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['skills'].widget.attrs.update({'placeholder': 'List your skills'})
        self.fields['experience'].widget.attrs.update({'placeholder': 'Mention your experience'})
        self.fields['education'].widget.attrs.update({'placeholder': 'Mention your education'})
        self.fields['location'].widget.attrs.update({'placeholder': 'Enter your location'})
        self.fields['interests'].widget.attrs.update({'placeholder': 'Mention your interests'})
        self.fields['languages'].widget.attrs.update({'placeholder': 'Languages you know'})
...
#     class Meta:
#         model = JobSeeker
#         fields = ['email', 'phone', 'skills', 'experience', 'education', 'resume']